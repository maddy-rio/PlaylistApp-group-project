...
import * as api from '../apis/playlist'
import { useEffect, useState } from 'react'
import { Album, Tracks } from '../../models/temp'
        ...
        <Flex height="100%" m="7">
          <div className="dashboard">
            <Heading as="h1" className="dashboard-h1 gradient-text">
              Hi {user}! Here’s all the playlists you’re collaborating on:
            </Heading>
            <Flex
                    ...
                    <Dialog.Content style={{ maxWidth: 450 }}>
                      ...
                      <Flex direction="column" gap="3">
                        <label>
                          ...
                          <TextField.Input placeholder="Enter playlist ID" />
                        </label>
                      </Flex>
                    </Dialog.Content>
                  </Dialog.Root>
